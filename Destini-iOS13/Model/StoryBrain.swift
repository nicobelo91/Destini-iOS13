...
struct StoryBrain {
    ...
    func nextTitle() -> String { //returns the corresponding title
        return stories[storyNumber].title
    }
    
    func nextchoice1() -> String { //returns the corresponding choice1
        return stories[storyNumber].choice1
    }
    
    func nextchoice2() -> String { //returns the corresponding choice2
